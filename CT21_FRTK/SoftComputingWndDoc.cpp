...
/*
void CSoftComputingWndDoc::InitCam()
{
	CMainFrame* mainframe = (CMainFrame*)AfxGetMainWnd();
	m_frtk.camview = (CMyCamView*)mainframe->GetCameraView();

	IPLIMAGE m_image = cvCreateImage(cvSize(320, 240), IPL_DEPTH_8U, 3);
...
void CSoftComputingWndDoc::CloseCam()
{
	m_frtk.FRTKend();
}
*/
