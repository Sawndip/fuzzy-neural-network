...
// X.map2(f) returns the element by element map2ping f(X)
	 doubleMatrix	map2(const double (*f)(const double&)) const;
	 doubleMatrix	map2(const double (*f)(      double )) const;
...
// Function Summary
	 ...
	 doubleMatrix	tanh2(doubleArray a);// { return a.map2(tanh); }
...
inline	 char*		format(char* s,int n = 0,char* w = " ");
...
inline	 double	 sgn(const double& a)	{ return a < 0.0? -1.0: +1.0; }
/*
inline	 doubleMatrix	 cos(const doubleArray& a) { return a.map2( cos); }
inline	 doubleMatrix	 sin(const doubleArray& a) { return a.map2( sin); }
inline	 doubleMatrix	 tan(const doubleArray& a) { return a.map2( tan); }
inline	 doubleMatrix	cosh(const doubleArray& a) { return a.map2(cosh); }
inline	 doubleMatrix	sinh(const doubleArray& a) { return a.map2(sinh); }
inline	 doubleMatrix	tanh(const doubleArray& a) { return a.map2(tanh); }
inline	 doubleMatrix	 exp(const doubleArray& a) { return a.map2( exp); }
inline	 doubleMatrix	 log(const doubleArray& a) { return a.map2( log); }
inline	 doubleMatrix	sqrt(const doubleArray& a) { return a.map2(sqrt); }

inline	 doubleMatrix	 abs(const doubleArray& a) { return a.map2(fabs); }
inline	 doubleMatrix	 sgn(const doubleArray& a) { return a.map2( sgn); }*/
